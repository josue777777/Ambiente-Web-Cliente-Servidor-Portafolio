                            ...
                            <form class="form-horizontal m-t-20" action="" method="POST">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input id="txtIdentificacion" name="txtIdentificacion" type="text"
                                        class="form-control form-control-lg" placeholder="Identificación">
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input id="txtCorreo" name="txtCorreo" type="email"
                                        class="form-control form-control-lg" placeholder="Correo">
                                </div>
                                ...
                                <div class="form-group m-b-0 m-t-10">
                                    <div class="col-sm-12 text-center">
                                        Si ya tienes una cuenta <a href="login.php" class="text-info m-l-5"><b>Inicia
                                                Sesión</b></a>
                                    </div>
                                    <div class="col-sm-12 text-center">
                                        Si olvidaste la contraseña <a href="recuperarAcceso.php"
                                            class="text-info m-l-5"><b>Recupera el Acceso</b></a>
                                    </div>
                                </div>
